...
const Home = () => {
  ...
  const additionalMenuItems = [
    { icon: Heart, label: 'Oração', path: '/oracao', bgColor: 'bg-blue-100', textColor: 'text-blue-700' },
    { icon: DollarSign, label: 'Contribuir', path: '/contribuicoes', bgColor: 'bg-blue-200', textColor: 'text-blue-800' },
    { icon: Users, label: 'Família', path: '/familia', bgColor: 'bg-blue-300', textColor: 'text-blue-900' },
  ];

  return (
    <div className="page-container space-y-6 animate-fade-in bg-blue-50">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2 text-blue-900">Bem-vindo à Igreja Renovada</h1>
        <p className="text-blue-700">Transformando vidas através da Palavra</p>
      </div>
      ...
      <div className="space-y-2">
        <h2 className="text-xl font-semibold text-blue-900">Vídeo em Destaque</h2>
        ...
        <p className="text-sm text-blue-700">{data.featuredVideo.title}</p>
      </div>
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-semibold text-blue-900">Próximos Eventos</h2>
        ...
        {data.events.slice(0, 2).map(event => (
          <Card key={event.id} className="card-hover bg-blue-100">
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-semibold text-blue-900">Devocional</h2>
          <Link to="/devocional" className="text-blue-600 text-sm font-medium flex items-center">
            <BookOpen className="h-4 w-4 mr-1" /> Ver mais
          </Link>
        </div>
        
        {data.devotionals.slice(0, 1).map(devotional => (
          <Card key={devotional.id} className="card-hover bg-blue-100">
            <CardContent className="p-4">
